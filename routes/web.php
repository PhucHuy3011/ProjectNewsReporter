...
Route::group([], function () {
    ...
    Route::get('/index', [ControllerProject::class, 'home']);

    Route::post('index/saveFeedback', [MylayoutController::class, 'saveFeedback']);
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/addFeedback', [MylayoutController::class, 'addFeedback']);
});
